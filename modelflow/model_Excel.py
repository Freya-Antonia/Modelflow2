...
def findequations(name):
    '''Takes all formula's from a excel work book and translates each to the equivalent expression.
        ...
        The ordinary operators and the SUM function can be handled. If you need more functions. You have to implement them in the modelclass.
    ...
    '''
    outdic={}
    wb = load_workbook(name, read_only=True,data_only=False) # to read the spreadsheet first save as xml then write it again
    try:
